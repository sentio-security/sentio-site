    ...
    <section className="flex flex-col items-center justify-center px-6 pt-40 pb-24 text-center">
      ...
      <div className="mb-10">
        <span
          ...
          style={{ fontFamily: "var(--font-inter)", color: "#2C1810" }}
        >
          sentio
      ...
      {/* Tagline */}
      <h1
        className="max-w-2xl text-4xl font-semibold leading-tight tracking-tight mb-4"
        style={{ color: "#2C1810" }}
      >
      ...
      {/* Install command */}
      <div
        className="flex items-center gap-3 px-5 py-3 rounded-md mb-8 font-mono text-sm"
        style={{
          background: "#2C1810",
          color: "#FBF0E4",
      ...
      >
        <span style={{ color: "#C4531A" }}>$</span>
        <span>cargo install sentio-cli</span>
